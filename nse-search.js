...
(function(){
  ...
  /* The live quote feed is already generated by GitHub Actions. Load the
     presentation layer here so index.html does not need another edit. */
  function loadLivePriceLayer(){
    if(document.querySelector('script[data-live-price-layer]'))return;
    const s=document.createElement("script");
    s.src="./live-price-ui.js?v="+Date.now();
    s.async=false;
    s.dataset.livePriceLayer="1";
    document.body.appendChild(s);
  }
  if(document.readyState==="loading")document.addEventListener("DOMContentLoaded",loadLivePriceLayer);else loadLivePriceLayer();
})();
